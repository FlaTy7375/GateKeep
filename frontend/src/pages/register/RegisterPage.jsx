...
function RegisterPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccess(response.data.message || 'Регистрация успешна! Перенаправление...');
            ...
            <div className="d-none d-lg-flex flex-column justify-content-between p-5" style={{
                ...
                <div>
                    <h1 className="fw-bold mb-4" style={{ fontSize: '2.5rem', lineHeight: '1.12', letterSpacing: '-0.03em' }}>
                        Начните работу за несколько секунд
                    </h1>
                    <p style={{ color: '#a5b4fc', fontSize: '1.05rem', lineHeight: '1.7' }}>
                        Создайте аккаунт и получите мгновенный доступ к управлению пользователями. 
                        Письмо-подтверждение придёт на вашу почту.
                    </p>
                ...
                <Container>
                    <Row className="justify-content-center">
                        <Col xs={11} sm={9} md={7} lg={8} xl={6}>
                            ...
                            <h3 className="fw-bold mb-1" style={{ letterSpacing: '-0.02em', color: '#1e1b4b' }}>Создать аккаунт</h3>
                            <p className="text-muted mb-4" style={{ fontSize: '0.9rem' }}>Заполните данные для регистрации</p>
                            ...
                            {success && (
                                <Alert variant="success" transition={false} className="py-2 small border-0" style={{ backgroundColor: '#f0fdf4', color: '#166534', borderRadius: '8px' }}>
                                    {success}
                                </Alert>
                            )}
                            ...
                            <Form onSubmit={handleSubmit}>
                                <Form.Group className="mb-3" controlId="registerName">
                                    <Form.Label className="fw-semibold mb-2" style={{ fontSize: '0.85rem', color: '#1e1b4b' }}>Ваше имя</Form.Label>
                                    <Form.Control
                                        type="text"
                                        placeholder="Имя"
                                        value={name}
                                ...
                                <Form.Group className="mb-3" controlId="registerEmail">
                                    <Form.Label className="fw-semibold mb-2" style={{ fontSize: '0.85rem', color: '#1e1b4b' }}>Ваш Email</Form.Label>
                                    <Form.Control
                                        type="email"
                            ...
                            <div className="text-center mt-4">
                                <small className="text-muted">
                                    Уже есть аккаунт?{' '}
                                    <Link to="/login" className="text-decoration-none fw-semibold" style={{ color: '#4f46e5', borderBottom: '1px solid #4f46e5' }}>
                                        Войти
                                    </Link>
                                </small>
                            </div>
